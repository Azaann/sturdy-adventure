...
WHERE Gerechtcategorie_ID = 3",[]);

$columns = array_keys($drinken[0]);
$row_data = array_values($drinken);

$soorten = $db->select("SELECT * FROM gerechtsoorten WHERE Gerechtcategorie_ID = 3",[]);
...
<body>
	...
	<table>
		...
		<tbody><h1>Hoofdgerechten wijzigen/deleten</h1>
	...
	<form method="post">
		...
		<h1>Hoofdgerechten toevoegen</h1>
